...
if __name__ == '__main__':
    def test_add_in_file():
        ...
        filename = "test_cars.txt"

        with open(filename, 'w', encoding='utf-8') as f:
            pass

        car.add_in_file(filename)

        with open(filename, 'r', encoding='utf-8') as f:
            lines = f.readlines()
            last_line = lines[-1]
            assert f'{car.mark} {car.model} {car.num} {car.engine} {car.color} {car.light} {car.doors} {car.maxV} {car.m}\n' == last_line
